 ...
 * 
 * - アノテーションの付与対象
 *   - java.lang.annotation.ElementType列挙型によって表される
 *   
 ...
 *     @Target({TYPE, FILED, METHOD, PARAMETER, CONSTRUCTOR, LOCAL_VARIABLE, MODULE, PACKAGE})
 *     @Documented
...
public class Main {
   ...
   * 
   * // アノテーション情報の取得
   * CustomAnnotation classAnnotation1 =
   * Greeting.class.getAnnotation(CustomAnnotation.class);
   * System.out.println("value = " + classAnnotation1.value());
   * System.out.println("elemName = " + classAnnotation1.elemName());
   * 
   * CustomAnnotation classAnnotation2 =
   * greeting.getClass().getAnnotation(CustomAnnotation.class);
